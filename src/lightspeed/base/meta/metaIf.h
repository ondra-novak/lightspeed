...
namespace LightSpeed {
	...
	///Chooses T1 or T2 depends on boolean condition
	template<bool cond, class T1, class T2> class MIf;
	template<class T1, class T2> class MIf<false,T1,T2> {public: typedef T2 T;};
	template<class T1, class T2> class MIf<true,T1,T2> {public: typedef T1 T;};
