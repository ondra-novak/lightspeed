...
class OldScheduler: public MsgQueue {
public:
	...
	OldScheduler();
	OldScheduler(IRuntimeAlloc &alloc);
...
template<typename Fn1, typename Fn2>
OldScheduler::AbstractMsg * OldScheduler::scheduleFnCall( Fn1 fn, Fn2 reject, natural interval )
{
...
template<typename Fn>
OldScheduler::AbstractMsg *OldScheduler::scheduleFnCall( Fn fnb, natural interval )
{
	class MyMsg: public AbstractEvent, public DynObject {
	public:
